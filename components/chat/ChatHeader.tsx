...
import { TopicWithPreview, Role } from '@/lib/types';
import { MemberModal } from './MemberModal';
import { ArrowLeft, Edit2, Trash2, Users, User, Share2, Shield, Eye } from 'lucide-react';
        ...
        <div className="px-4 py-3 flex items-center justify-between">
          <div className="flex items-center gap-3 min-w-0">
            ...
            <div className="min-w-0">
              <div className="flex items-center gap-2">
                ...
                {isViewer && (
                  <span className="text-[10px] bg-yellow-500/20 text-yellow-400 border border-yellow-500/30 px-1.5 py-0.5 rounded font-semibold flex items-center gap-1">
          ...
          <div className="flex items-center gap-1.5 shrink-0">
            ...
            >
              ...
              {memberCount > 0 && (
                <span className="bg-[#00A884]/20 text-[#00A884] px-1.5 py-0.2 rounded-full text-[10px]">
                  {memberCount}
                </span>
              )}
            </button>
